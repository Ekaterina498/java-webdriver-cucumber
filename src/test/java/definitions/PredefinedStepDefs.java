...
public class PredefinedStepDefs {
    ...
    public void iDonTSeeAdminControls() {
        System.out.println("Checking that admin control is not available");
    }

    @And("I see admin controls")
    public void iSeeAdminControls() {
        System.out.println("Checking that admin control is available");
    }
}
